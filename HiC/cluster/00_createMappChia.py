...
filesPath = '/home/jmendietaes/data/2021/HiC/sequencedData/NextSeq2000.RUN115.20221026/demux_fastq/toMapp.txt'
...
# get output folder
path = '/home/jmendietaes/data/2021/HiC/mapOut/'
...
scriptsPath = '/home/jmendietaes/programas/PhD/HiC/cluster/'
...
for nr in range(0, njobs):
	cmd=''
	cmd+='%s00_mapper.py -fq1 %s '%(scriptsPath, reads[nr][0])
...
fileID=$(a=(${fileID//_R1_001/ }); echo ${a[0]})
