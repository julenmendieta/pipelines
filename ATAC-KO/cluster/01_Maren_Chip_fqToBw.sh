...
# sbatch --array=1-${N} /home/jmendietaes/programas/pipelines/ATAC-KO/cluster/01_Maren_Chip_fqToBw.sh \
#/home/jmendietaes/data/2021/ATAC/sequencedData/mnavarroa \
...
bamSortMarkDupBlackChr="${EDITED_DIR}/BAM/${filename}.sort.rmdup.rmblackls.rmchr.bam"
...
if [[ ${linec} != "Tn5Adjust" ]]; then 
    # # use --ATACshift
    bamMarkDupBlackChrTn5="${EDITED_DIR}/BAM/${filename}.rmdup.rmblackls.rmchr.Tn5.bam"
    bamSortMarkDupBlackChrTn5="${bamsPath}/${filename}.sort.rmdup.rmblackls.rmchr.Tn5.bam"
...
bigWigOut="${basePath}/BigWig/${filename}.sort.rmdup.rmblackls.rmchr.Tn5.norm.bw"
...
#     #samtools view -b ${bamSortMarkDupBlackChrTn5} | genomeCoverageBed -ibam stdin -g $chr_genome_size -bg > ${basePath}/BigWig/${filename}.sort.rmdup.rmblackls.rmchr.gencovnorm.bedGraph
