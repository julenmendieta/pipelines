...
Modified to work with broad peaks
'''
...
try:
    ...
    # If we opened a broadPeak file
    peak_data.columns = ["chromosome", "start", "end", "A", "B", "C", "Signal_value", "D", "E"]
    peak_data["offset"] = round((peak_data["start"] + peak_data["end"]) / 2) - peak_data["start"]
